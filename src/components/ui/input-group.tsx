...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: groups an input with its addons, not a form fieldset
    <div
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: groups an addon icon/button with the input, not a form fieldset
    // biome-ignore lint/a11y/useKeyWithClickEvents: click only refocuses the sibling input as a convenience; the real interactive elements inside (button/input) are already keyboard-reachable on their own
    <div
      role="group"
