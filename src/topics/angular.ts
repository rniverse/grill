...
export const questions: Question[] = [
  ...
  },
  {
    ...
    references: [],
    related: [],
    answer: { type: 'md-text', value: "Attach a custom validator function to the parent `FormGroup` (not the individual controls), since it needs access to sibling controls' values — e.g., comparing `password` and `confirmPassword` and returning a validation error object on the group if they don't match." },
  },
  {
  ...
  },
  {
    ...
    references: [],
    related: [],
    answer: { type: 'md-text', value: `This is an open scenario prompt: describe a real performance problem you diagnosed in an Angular app, and what you changed. There's no single expected fix here — the interviewer wants your own debugging story. ${scenarioStructureFraming}` },
  },
  {
  ...
  },
  {
    ...
    references: [],
    related: [],
    answer: { type: 'md-text', value: `This is an open scenario prompt: when would you deliberately *not* use Signals, even in a green-field v18+ app? There's no single expected answer — the interviewer wants your own reasoning about the trade-off, not a rule you memorized. ${scenarioStructureFraming}` },
  },
  {
  ...
  },
  {
    ...
    references: [],
    related: [],
    answer: { type: 'md-text', value: `This is an open scenario prompt: how do you decide what should live in a Signal vs an Observable vs an NgRx store in a medium-sized app? There's no single expected answer — the interviewer wants your own criteria for that trade-off. ${scenarioStructureFraming}` },
  },
]
